...
# PairProgram — Live Debug MCP Tools
...
2. User opens the PairProgram sidebar -> fills "What do you want to investigate?" + stop reason -> clicks **Push to Agent**
...
### `mcp__pairprogram-debug__debug_status`
...
### `mcp__pairprogram-debug__get_execution_context`
...
### `mcp__pairprogram-debug__list_variables`
...
### `mcp__pairprogram-debug__get_variable_schema`
...
### `mcp__pairprogram-debug__get_variable_value`
