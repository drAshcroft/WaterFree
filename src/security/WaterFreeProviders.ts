...
export const MODEL_CATALOG: ModelDescriptor[] = [
  ...
  // Ollama (local, free)
  { id: "freehuntx/qwen3-coder:14b", provider: "ollama", tier: "balanced", capabilities: ["tools","streaming","long_context"], contextWindow: 40960, maxOutput: 8192, inputCostPer1M: 0, outputCostPer1M: 0 },
