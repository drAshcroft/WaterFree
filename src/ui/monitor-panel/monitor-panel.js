...
/**
 * WaterFree Monitor Panel webview script.
 *
 * Receives messages from MonitorPanel.ts:
...
const badgePersona = /** @type {HTMLElement} */ (document.getElementById("badge-persona"));
...
function showCapture(capture) {
  ...
  badgePersona.textContent = capture.persona || "default";
