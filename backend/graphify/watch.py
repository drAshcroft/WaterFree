...
def _rebuild_code(
    ...
    *,
    ...
    try:
        from .extract import extract, _get_extractor
        from .detect import detect
        from .build import build_from_json, _norm_source_file as _nsf
        ...
        if no_cluster:
            ...
            try:
                from .detect import save_manifest
        ...
        if no_change:
            ...
            if not _check_shrink(
                ...
                return False
            from .export import backup_if_protected as _backup
            _backup(out)
        ...
        if callflow_files and not no_change:
            try:
                from .callflow_html import write_callflow_html
