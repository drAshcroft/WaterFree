...
def uninstall_all(project_dir: Path | None = None, purge: bool = False) -> None:
    ...
    # Git hook
    try:
        from .hooks import uninstall as hook_uninstall
...
def main() -> None:
    ...
    if cmd == "install":
        ...
        from .llm import _custom_providers_path, BACKENDS
        ...
        if subcmd == "list":
            ...
            if not base_url or not default_model or not env_key:
                ...
                sys.exit(1)
            from .llm import provider_base_url_ok
        ...
        if len(sys.argv) < 3:
            ...
            sys.exit(1)
        from .affected import DEFAULT_AFFECTED_RELATIONS, format_affected, load_graph
        query = sys.argv[2]
        ...
        from .cluster import cluster, score_all, remap_communities_to_previous
        from .analyze import (
            god_nodes,
        ...
        if labels_path.exists() and not force_relabel:
            ...
            from .llm import generate_community_labels
        ...
        from .export import _git_head as _gh
        _commit = _gh()
        ...
        from .tree_html import write_tree_html, DEFAULT_MAX_CHILDREN
        ...
        import networkx as _nx
        from networkx.readwrite import json_graph as _jg
        from .build import prefix_graph_for_global as _prefix
        graphs = []
        ...
        if subcmd == "callflow-html":
            from .callflow_html import write_callflow_html as _write_callflow_html
        ...
        from networkx.readwrite import json_graph as _jg
        from .build import build_from_json as _bfj
        ...
        if subcmd == "html":
            from .export import to_html as _to_html
            if no_viz:
            ...
            from .export import to_obsidian as _to_obsidian, to_canvas as _to_canvas
            ...
            from .wiki import to_wiki as _to_wiki
            ...
            if neo4j_uri:
                ...
                from .export import to_cypher as _to_cypher
        ...
        if needs_llm:
            if backend is None:
                ...
                sys.exit(1)
            if backend == "ollama":
                from .llm import _validate_ollama_base_url
        ...
        if code_files:
            from .extract import extract as _ast_extract
        ...
        if cli_postgres_dsn is not None:
            from .pg_introspect import introspect_postgres
        ...
        if no_cluster:
            ...
            if global_merge:
                from .global_graph import global_add as _global_add
        ...
        from .cluster import cluster as _cluster, score_all as _score_all
        from .export import to_json as _to_json
        from .analyze import god_nodes as _god_nodes, surprising_connections as _surprising
        ...
        from .cache import check_semantic_cache
        if len(sys.argv) < 3:
